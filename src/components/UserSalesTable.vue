        ...
        <div class="filters-panel-v2">
            ...
            <div class="filters-main-row">
                ...
                <div class="filters-right-group">
                    ...
                    <select v-model="syncTimeframe" class="sync-time-select" :disabled="syncState.isSyncing || isLoadingAccounts">
...
.sync-time-select { padding: 0.5rem 1rem; border: 1px solid #e2e8f0; border-radius: 0.5rem; background-color: #ffffff; color: #475569; font-size: 0.875rem; font-weight: 500; outline: none; transition: border-color 0.2s; margin-right: 8px;}
